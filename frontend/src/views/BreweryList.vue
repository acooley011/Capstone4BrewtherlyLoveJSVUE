...
<main class="main">
  <div class="is-size-4 has-text-weight-semibold box has-text-centered text-box">
    <p><strong>Brewery ARS</strong></p><br/>
    <div class="columns is-mobile">
      <div>
       <img src="../assets/images/Breweries/breweryARS.png" width="500vw" style="margin-right: 15vw;"/>
      </div>
      <div id="brewery-info" class="text-box" width="25vw;">
        <p style="width: 25vw">Brewery ARS is a small garage brewery in South Philadelphia and the brainchild of Andy and Sean Arsenault, who began their brewing career as engineers with curiosity. After spending Friday evenings at the Foodery at 10th and Pine with a 6 pack of Yuengling and one craft beer from around the world each week, the brothers realized that they both were fond of the Belgian styles and grew an affinity for yeast-forward beers. After years of planning and tinkering recipes, the brewery officially opened its doors on December 17, 2016. Since then, the duo have brewed over 70 different batches of 56 different beers, including collaborations with Highway Manor Brewing and Kurant Ciders, exploring the endless flavor profiles craft beer has to offer.</p>
      </div>
    </div>
    </div>
